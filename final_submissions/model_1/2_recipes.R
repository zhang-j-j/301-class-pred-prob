...
# more complex recipe for random forest and boosted tree
...
# 95 predictor columns after preprocessing

# save recipe
save(tree_rec, file = here("final_submissions/model_1/recipes/tree_rec.rda"))
